...
//                                                                         //
//-------------------------------------------------------------------------//
// $Id: at17xxx.h,v 1.2 2007/04/20 10:58:20 lancos Exp $
//-------------------------------------------------------------------------//
//                                                                         //
...
//	int Probe(int probe_size = 0);
  ...
  protected:	//--------------------------------------- protected
	...
	int WritePage(long addr, int addr_bytes, BYTE *buf, int len);
	int ReadPage(long addr, int addr_bytes, BYTE *buf, int len);
